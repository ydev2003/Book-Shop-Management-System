...
void bookshope::add_book()
{
    ...
    // output mode
    file.open("F://CPP//Cpp Projects// book.txt",
              ios::out | ios::app);
    file << " " << b_id << " "
         << b_name << " " << a_name
         << " " << price << "\n";
...
void bookshope::show_book()
{
    ...
    file.open("F://CPP//Cpp Projects// book.txt", ios::in);
    if (!file)
        cout << "\n\nFile Opening Error!";
    else {
...
void bookshope::update_book()
{
    system("cls");
    fstream file, file1;
    int price, no_co, count = 0;
    string b_name, b_na, a_name;
    string a_na, b_idd, b_id;
  
    cout << "\n\n\t\t\t\tUpdate Book Record";
    file1.open("F://CPP//Cpp Projects// book.txt",
               ios::app | ios::out);
    file.open("F://CPP//Cpp Projects// book.txt", ios::in);
    ...
    file.close();
    file1.close();
    remove("F://CPP//Cpp Projects// book.txt");
    rename("F://CPP//Cpp Projects// book.txt",
           "F://CPP//Cpp Projects// book.txt");
}
...
void bookshope::del_book()
{
    ...
    file1.open("F://CPP//Cpp Projects// book1.txtt",
               ios::app | ios::out);
    file.open("F://CPP//Cpp Projects// book.txt",
              ios::in);
    ...
    file1.close();
    remove("F://CPP//Cpp Projects// book.txt");
    rename("F://CPP//Cpp Projects// book1.txt",
           "F://CPP//Cpp Projects// book.txt");
}
